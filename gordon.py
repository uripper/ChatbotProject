print("Warming up Gordon...")

from transformers import AutoTokenizer, AutoModelForCausalLM
import torch
import torch.nn.functional as F

tokenizer = AutoTokenizer.from_pretrained('uripper/ChatbotTrainingBot')

model = AutoModelForCausalLM.from_pretrained('uripper/ChatbotTrainingBot', revision="movie_lines")
